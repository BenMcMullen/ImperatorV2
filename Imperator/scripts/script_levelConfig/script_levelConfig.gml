...
function LevelConfiguration() {
	...
	function LevelConfig(_enemyTypes, _levelPoints, _room, _contract) {
    return {
	...
	global.levels[7] = LevelConfig(global.enemyTypes[0], 500, room_3, 5);
	global.levels[8] = LevelConfig([global.enemyTypes[0], global.enemyTypes[0]], 800, room_4, 6);
