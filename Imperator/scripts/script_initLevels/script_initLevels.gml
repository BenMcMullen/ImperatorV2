...
function InitLevels() {
	...
	global.levels[7] = LevelConfig(8, global.enemyTypes[0], 200, room_1, 2);
	global.levels[8] = LevelConfig(9, global.enemyTypes[0], 300, room_2, 3);
	global.levels[9] = LevelConfig(10, global.enemyTypes[0], 500, room_3, 5);
	global.levels[10] = LevelConfig(11, [global.enemyTypes[0], global.enemyTypes[0]], 800, room_4, 6);
