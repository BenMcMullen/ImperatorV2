function InitLevels() {
    ...
    function ProtectLevelTypeConfig(_type, _damageCap) {
        return {
            type: _type,
    ...
    // Martian Levels
    global.martianTreeLevels[0] = LevelConfigMartian(global.enemyTypes[0], 201, room_1, 2, global.levelTypeHunting[0], 1, false, "Operation: Red Storm", spr_brief, [], 5, global.difficulties[0]);
