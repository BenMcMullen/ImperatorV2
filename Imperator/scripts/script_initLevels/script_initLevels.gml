function InitLevels() {
    ...
    // Martian Levels
    global.martianTreeLevels[0] = LevelConfigMartian(300, room_levelPayload, 3, global.levelTypePayload[0], 1, false, "Operation: Desert Siege", spr_brief, noone, 100, global.difficulties[0]);
