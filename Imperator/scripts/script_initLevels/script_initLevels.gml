function InitLevels() {
    ...
    // Martian Levels
    global.martianTreeLevels[0] = LevelConfigMartian(global.enemyTypes[0], 201, room_1, 2, [], 1, false, "Operation: Red Storm", spr_brief, [global.primaryWeapons[3]], 5, global.difficulties[0]);
