...
IMPLEMENT COMMENDATIONS UI
REFACTOR GAMECONTROLLER GUI FOR NEW LEVELTYPES AND SUCH
ADD BACK POINTS TO SHOP
CREATE RANK UP MECHANIC, CUTSVENE(?) VISUALS.
PLANET SELECTION
CUTSCENES
...
ENEMY TYPES
ENEMY AI
TYPES OF MISSIONS- CONTRACT, SURVIVAL, ESCAPE, OBJECTIVES? Create an object with step events that check for state
based completions of the given level- i could even run scripts per level, or make it dynamic to check the
current levels requirements for completion
FINAL BOSS
...
Deaths re-route you to the ??? Your mission is considered "completed"
but you obviously don't get points, and you don't get commendation. Probably EVENTUALLY want to putt in an edge case where if you have no remaining missions at your difficulty on 
ANY of your trees you lose. When you die, you lose your ships and your upgrades on that ship. Those upgrades are then removed completed from the list, and your ship is as well. 