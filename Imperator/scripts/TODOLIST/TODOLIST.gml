...
CHECK PHONE RECORDING- HAS LOTS OF GOOD STUFF
MAKE PLANETS VEIW, CLICK A PLANET DOES CUTSCENE AND GOES BACK TO BRIDGE,
CHANGES BG AND BRIEFING SELECTION. TRIGGER IMPERATOR DIALOGUE CHANGES. 
ADD BACKSTORY

idea: show all selected missions for tree/difficulty? some mechanism to limit choices.